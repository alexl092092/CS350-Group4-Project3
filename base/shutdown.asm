 ...
 338:	89 d1                	mov    %edx,%ecx
{
 ...
 36b:	0f b6 92 40 07 00 00 	movzbl 0x740(%edx),%edx
 ...
 3d9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 444:	ff 24 85 e8 06 00 00 	jmp    *0x6e8(,%eax,4)
 ...
 550:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 555:	bb de 06 00 00       	mov    $0x6de,%ebx
...
free(void *ap)
{
 ...
 561:	a1 dc 09 00 00       	mov    0x9dc,%eax
{
 ...
 59f:	5b                   	pop    %ebx
  freep = p;
 5a0:	a3 dc 09 00 00       	mov    %eax,0x9dc
}
 5a5:	5e                   	pop    %esi
 5a6:	5f                   	pop    %edi
 5a7:	5d                   	pop    %ebp
 ...
 5b6:	72 ce                	jb     586 <free+0x26>
{
 ...
 5d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5da:	a3 dc 09 00 00       	mov    %eax,0x9dc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 5f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 5fc:	8b 15 dc 09 00 00    	mov    0x9dc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 63b:	3b 05 dc 09 00 00    	cmp    0x9dc,%eax
 ...
 65e:	e8 fd fe ff ff       	call   560 <free>
  return freep;
 663:	8b 15 dc 09 00 00    	mov    0x9dc,%edx
 ...
 68c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 68f:	89 15 dc 09 00 00    	mov    %edx,0x9dc
}
 ...
 69f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6a0:	c7 05 dc 09 00 00 e0 	movl   $0x9e0,0x9dc
 6a7:	09 00 00 
    base.s.size = 0;
 6aa:	b8 e0 09 00 00       	mov    $0x9e0,%eax
    base.s.ptr = freep = prevp = &base;
 6af:	c7 05 e0 09 00 00 e0 	movl   $0x9e0,0x9e0
 6b6:	09 00 00 
    base.s.size = 0;
 6b9:	c7 05 e4 09 00 00 00 	movl   $0x0,0x9e4
 6c0:	00 00 00 
    if(p->s.size >= nunits){
