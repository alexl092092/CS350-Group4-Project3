...
fork1(void)
{
  ...
  exit();
     ...
     10b:	68 4f 13 00 00       	push   $0x134f
     110:	6a 02                	push   $0x2
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 43 13 00 00       	push   $0x1343
     17e:	6a 02                	push   $0x2
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c1:	0f 87 c8 00 00 00    	ja     28f <runcmd+0xdf>
     1c7:	8b 03                	mov    (%ebx),%eax
     1c9:	ff 24 85 80 13 00 00 	jmp    *0x1380(,%eax,4)
    printf(2, "Pipe Not implemented\n");
     1d0:	52                   	push   %edx
     1d1:	52                   	push   %edx
     1d2:	68 c4 12 00 00       	push   $0x12c4
     1d7:	6a 02                	push   $0x2
     1d9:	e8 82 0d 00 00       	call   f60 <printf>
    break;
     1de:	83 c4 10             	add    $0x10,%esp
     1e1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
     1e8:	e8 16 0c 00 00       	call   e03 <exit>
    printf(2, "Backgrounding not implemented\n");
     1ed:	50                   	push   %eax
     1ee:	50                   	push   %eax
     1ef:	68 60 13 00 00       	push   $0x1360
     1f4:	6a 02                	push   $0x2
     1f6:	e8 65 0d 00 00       	call   f60 <printf>
    break;
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     20c:	52                   	push   %edx
     20d:	50                   	push   %eax
     20e:	e8 28 0c 00 00       	call   e3b <exec>
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     213:	83 c4 0c             	add    $0xc,%esp
     216:	ff 73 04             	push   0x4(%ebx)
     219:	68 97 12 00 00       	push   $0x1297
     21e:	6a 02                	push   $0x2
     220:	e8 3b 0d 00 00       	call   f60 <printf>
    break;
    ...
    printf(2, "Redirection Not Implemented\n");
     22a:	53                   	push   %ebx
     22b:	53                   	push   %ebx
     22c:	68 a7 12 00 00       	push   $0x12a7
     231:	6a 02                	push   $0x2
     233:	e8 28 0d 00 00       	call   f60 <printf>
    break;
     238:	83 c4 10             	add    $0x10,%esp
     23b:	eb ab                	jmp    1e8 <runcmd+0x38>
    if(lcmd->left->type == LIST){
     23d:	8b 43 04             	mov    0x4(%ebx),%eax
     240:	83 38 04             	cmpl   $0x4,(%eax)
     243:	0f 84 98 00 00 00    	je     2e1 <runcmd+0x131>
    if(lcmd->left->type == EXEC){
     249:	83 38 01             	cmpl   $0x1,(%eax)
     24c:	74 4e                	je     29c <runcmd+0xec>
    if(lcmd->right->type == LIST){
     24e:	8b 43 08             	mov    0x8(%ebx),%eax
     251:	83 38 04             	cmpl   $0x4,(%eax)
     254:	0f 84 9d 00 00 00    	je     2f7 <runcmd+0x147>
    if(lcmd->right->type == EXEC){
     25a:	83 38 01             	cmpl   $0x1,(%eax)
     25d:	75 89                	jne    1e8 <runcmd+0x38>
	  if(ecmd1->argv[0] == 0)
     25f:	8b 50 04             	mov    0x4(%eax),%edx
     262:	85 d2                	test   %edx,%edx
     264:	74 82                	je     1e8 <runcmd+0x38>
      exec(ecmd1->argv[0], ecmd1->argv);
     266:	83 c0 04             	add    $0x4,%eax
     269:	51                   	push   %ecx
     26a:	51                   	push   %ecx
     26b:	50                   	push   %eax
     26c:	52                   	push   %edx
     26d:	e8 c9 0b 00 00       	call   e3b <exec>
      printf(2, "exec %s failed\n", ecmd->argv[0]);
     272:	83 c4 0c             	add    $0xc,%esp
     275:	ff 35 04 00 00 00    	push   0x4
     27b:	68 97 12 00 00       	push   $0x1297
     280:	6a 02                	push   $0x2
     282:	e8 d9 0c 00 00       	call   f60 <printf>
     287:	83 c4 10             	add    $0x10,%esp
     28a:	e9 59 ff ff ff       	jmp    1e8 <runcmd+0x38>
    panic("runcmd");
     28f:	83 ec 0c             	sub    $0xc,%esp
     292:	68 90 12 00 00       	push   $0x1290
     297:	e8 d4 fe ff ff       	call   170 <panic>
      if(fork1() == 0){
     29c:	e8 ef fe ff ff       	call   190 <fork1>
     2a1:	85 c0                	test   %eax,%eax
     2a3:	75 32                	jne    2d7 <runcmd+0x127>
		  struct execcmd *ecmd1 = (struct execcmd*)lcmd->left;
     2a5:	8b 43 04             	mov    0x4(%ebx),%eax
		  if(ecmd1->argv[0] == 0)
     2a8:	8b 50 04             	mov    0x4(%eax),%edx
     2ab:	85 d2                	test   %edx,%edx
     2ad:	0f 84 35 ff ff ff    	je     1e8 <runcmd+0x38>
		  exec(ecmd1->argv[0], ecmd1->argv);
     2b3:	83 c0 04             	add    $0x4,%eax
     2b6:	51                   	push   %ecx
     2b7:	51                   	push   %ecx
     2b8:	50                   	push   %eax
     2b9:	52                   	push   %edx
     2ba:	e8 7c 0b 00 00       	call   e3b <exec>
		  printf(2, "exec %s failed\n", ecmd->argv[0]);
     2bf:	83 c4 0c             	add    $0xc,%esp
     2c2:	ff 35 04 00 00 00    	push   0x4
     2c8:	68 97 12 00 00       	push   $0x1297
     2cd:	6a 02                	push   $0x2
     2cf:	e8 8c 0c 00 00       	call   f60 <printf>
     2d4:	83 c4 10             	add    $0x10,%esp
      wait();
     2d7:	e8 2f 0b 00 00       	call   e0b <wait>
     2dc:	e9 6d ff ff ff       	jmp    24e <runcmd+0x9e>
    	if(fork1() == 0){
     2e1:	e8 aa fe ff ff       	call   190 <fork1>
     2e6:	85 c0                	test   %eax,%eax
     2e8:	74 23                	je     30d <runcmd+0x15d>
    	wait();
     2ea:	e8 1c 0b 00 00       	call   e0b <wait>
     2ef:	8b 43 04             	mov    0x4(%ebx),%eax
     2f2:	e9 52 ff ff ff       	jmp    249 <runcmd+0x99>
    	if(fork1() == 0){
     2f7:	e8 94 fe ff ff       	call   190 <fork1>
     2fc:	85 c0                	test   %eax,%eax
     2fe:	74 18                	je     318 <runcmd+0x168>
    	wait();
     300:	e8 06 0b 00 00       	call   e0b <wait>
     305:	8b 43 08             	mov    0x8(%ebx),%eax
     308:	e9 4d ff ff ff       	jmp    25a <runcmd+0xaa>
    		runcmd(lcmd->left);
     30d:	83 ec 0c             	sub    $0xc,%esp
     310:	ff 73 04             	push   0x4(%ebx)
     313:	e8 98 fe ff ff       	call   1b0 <runcmd>
    		runcmd(lcmd->right);
     318:	83 ec 0c             	sub    $0xc,%esp
     31b:	ff 73 08             	push   0x8(%ebx)
     31e:	e8 8d fe ff ff       	call   1b0 <runcmd>
  ...
  *ps = s;
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     526:	50                   	push   %eax
     527:	68 c0 19 00 00       	push   $0x19c0
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     545:	50                   	push   %eax
     546:	68 c8 19 00 00       	push   $0x19c8
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     663:	68 f7 12 00 00       	push   $0x12f7
     668:	53                   	push   %ebx
     669:	56                   	push   %esi
  ...
  return cmd;
     ...
     77e:	68 da 12 00 00       	push   $0x12da
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     79f:	68 fa 12 00 00       	push   $0x12fa
     7a4:	56                   	push   %esi
     7a5:	53                   	push   %ebx
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     806:	68 11 13 00 00       	push   $0x1311
     80b:	56                   	push   %esi
     80c:	53                   	push   %ebx
    ...
    if(argc >= MAXARGS)
     ...
     850:	68 03 13 00 00       	push   $0x1303
  ...
  cmd->eargv[argc] = 0;
     ...
     899:	68 fc 12 00 00       	push   $0x12fc
...
000008b0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8c9:	68 16 13 00 00       	push   $0x1316
  cmd = parseexec(ps, es);
...
00000940 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     99b:	68 18 13 00 00       	push   $0x1318
     9a0:	57                   	push   %edi
     9a1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9b1:	68 14 13 00 00       	push   $0x1314
     9b6:	57                   	push   %edi
     9b7:	56                   	push   %esi
...
00000a20 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a2f:	68 fa 12 00 00       	push   $0x12fa
     a34:	56                   	push   %esi
     a35:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a59:	68 36 13 00 00       	push   $0x1336
  cmd = parseline(ps, es);
     ...
     b55:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     b9e:	52                   	push   %edx
     b9f:	50                   	push   %eax
     ba0:	68 38 13 00 00       	push   $0x1338
     ba5:	6a 02                	push   $0x2
     ba7:	e8 b4 03 00 00       	call   f60 <printf>
    panic("syntax");
     bac:	c7 04 24 fc 12 00 00 	movl   $0x12fc,(%esp)
     ...
     ec8:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     efb:	0f b6 92 10 14 00 00 	movzbl 0x1410(%edx),%edx
     ...
     f69:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     fc6:	0f 84 24 01 00 00    	je     10f0 <printf+0x190>
     fcc:	83 e8 63             	sub    $0x63,%eax
     fcf:	83 f8 15             	cmp    $0x15,%eax
     fd2:	77 1c                	ja     ff0 <printf+0x90>
     fd4:	ff 24 85 b8 13 00 00 	jmp    *0x13b8(,%eax,4)
  ...
  write(fd, &c, 1);
    ...
    105d:	0f 84 9d 00 00 00    	je     1100 <printf+0x1a0>
        while(*s != 0){
    1063:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
    1066:	31 d2                	xor    %edx,%edx
        while(*s != 0){
    1068:	84 c0                	test   %al,%al
    106a:	0f 84 3d ff ff ff    	je     fad <printf+0x4d>
    1070:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1073:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    1076:	89 de                	mov    %ebx,%esi
    1078:	89 d3                	mov    %edx,%ebx
  ...
  write(fd, &c, 1);
    ...
    10b6:	b9 0a 00 00 00       	mov    $0xa,%ecx
    10bb:	8b 13                	mov    (%ebx),%edx
    10bd:	6a 01                	push   $0x1
    10bf:	e9 6b ff ff ff       	jmp    102f <printf+0xcf>
    10c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        putc(fd, *ap);
    10c8:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
    10cb:	83 ec 04             	sub    $0x4,%esp
    10ce:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
    10d1:	8b 03                	mov    (%ebx),%eax
        ap++;
    10d3:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
  ...
  write(fd, &c, 1);
    ...
    10db:	52                   	push   %edx
    10dc:	57                   	push   %edi
    10dd:	e8 41 fd ff ff       	call   e23 <write>
        ap++;
    10e2:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    10e5:	83 c4 10             	add    $0x10,%esp
      state = 0;
    10e8:	31 d2                	xor    %edx,%edx
    10ea:	e9 be fe ff ff       	jmp    fad <printf+0x4d>
    10ef:	90                   	nop
  write(fd, &c, 1);
    ...
    10f9:	6a 01                	push   $0x1
    10fb:	e9 11 ff ff ff       	jmp    1011 <printf+0xb1>
    1100:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    1105:	bb b0 13 00 00       	mov    $0x13b0,%ebx
    110a:	e9 61 ff ff ff       	jmp    1070 <printf+0x110>
    110f:	90                   	nop
    ...
    1111:	a1 44 1a 00 00       	mov    0x1a44,%eax
{
  ...
  freep = p;
    ...
    1162:	72 d0                	jb     1134 <free+0x24>
    1164:	eb c2                	jmp    1128 <free+0x18>
    1166:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    116d:	8d 76 00             	lea    0x0(%esi),%esi
    bp->s.size += p->s.ptr->s.size;
    1170:	03 70 04             	add    0x4(%eax),%esi
    1173:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    1176:	8b 02                	mov    (%edx),%eax
    1178:	8b 00                	mov    (%eax),%eax
    117a:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
    117d:	8b 42 04             	mov    0x4(%edx),%eax
    1180:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    1183:	39 f1                	cmp    %esi,%ecx
    1185:	75 c8                	jne    114f <free+0x3f>
    p->s.size += bp->s.size;
    1187:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
    118a:	89 15 44 1a 00 00    	mov    %edx,0x1a44
    p->s.size += bp->s.size;
    1190:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    1193:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    1196:	89 0a                	mov    %ecx,(%edx)
}
    1198:	5b                   	pop    %ebx
    1199:	5e                   	pop    %esi
    119a:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    11eb:	39 05 44 1a 00 00    	cmp    %eax,0x1a44
  ...
  return freep;
    1213:	8b 15 44 1a 00 00    	mov    0x1a44,%edx
    ...
    123c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    123f:	89 15 44 1a 00 00    	mov    %edx,0x1a44
}
    ...
    124f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    1250:	c7 05 44 1a 00 00 48 	movl   $0x1a48,0x1a44
    1257:	1a 00 00 
    base.s.size = 0;
    125a:	b8 48 1a 00 00       	mov    $0x1a48,%eax
    base.s.ptr = freep = prevp = &base;
    125f:	c7 05 48 1a 00 00 48 	movl   $0x1a48,0x1a48
    1266:	1a 00 00 
    base.s.size = 0;
    1269:	c7 05 4c 1a 00 00 00 	movl   $0x0,0x1a4c
    1270:	00 00 00 
    if(p->s.size >= nunits){
